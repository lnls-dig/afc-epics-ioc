...
namespace {
    ...
    enum class channel_organizations {lamp, dcc, sysid, sysid_applied, sysid_filtered, last};
    const enum_info invalid_channel = {"invalid", MINOR_ALARM};
    const enum_info channel_info[][(int)channel_organizations::last] = {
        {{"lamp"}, invalid_channel, invalid_channel, invalid_channel, invalid_channel},
        {invalid_channel, {"dcc"}, invalid_channel, invalid_channel, invalid_channel},
        {invalid_channel, invalid_channel, {"sysid"}, {"sysid_applied"}, {"sysid_filtered"}},
    };
